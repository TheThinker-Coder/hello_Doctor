					...
					<div class="col-lg-7 top-social-agile">
						<div class="row">
							...
							<ul class="col-lg-4 col-6 top-right-info text-center">
								...
								<li class="mx-3"><a href="#"> <i class="fab fa-twitter"></i>
								</a></li>
								<li><a href="#"> <i class="fab fa-google-plus-g"></i>
								</a></li>
								<li class="ml-3"><a href="#"> <i
										class="fab fa-pinterest-p"></i>
								</a></li>
							</ul>
							<!-- //social icons -->
							<div
								class="col-6 header-top_w3layouts pl-3 text-lg-left text-center">
								<p class="text-white">
									<i class="fas fa-map-marker-alt mr-2"></i>Parma Via Modena,BO,
									Italy
								</p>
							</div>
						</div>
							...
							<div class="col-lg-7 col-6 top-w3layouts">
								<p class="text-white">
									<i class="far fa-envelope-open mr-2"></i> <a
										href="mailto:info@example.com" class="text-white">info@example.com</a>
								</p>
							</div>
				...
				<div class="container">
					...
					<h1>
						<a class="navbar-brand font-weight-bold font-italic"
							href="DoctorIndex.jsp"> <span>H</span>ELLO DOCTOR <i
					...
					<div class="collapse navbar-collapse text-center"
						...
						<ul class="navbar-nav ml-lg-auto">
							<li class="nav-item active mt-lg-0 mt-3"><a class="nav-link"
								href="DoctorIndex.jsp">Home <span class="sr-only">(current)</span>
							</a></li>
							...
							<li class="nav-item dropdown"><a
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<a class="dropdown-item scroll" href="#services">Services</a> <a
										class="dropdown-item" href="gallery.html">Gallery</a> <a
										class="dropdown-item scroll" href="#blog">Blog</a>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item" href="single.html"></a>
								</div></li>
						...
						<div class="login px-4 mx-auto mw-100">
							...
							<form action="Doctor_Login" method="post">
								<div class="form-group">
									<label>Your Email</label> <input type="email" id="uname"
										class="form-control" name="Doctor_email"
										placeholder="Enter the Valid Number" required="required">
								</div>
								<div class="form-group">
									<label class="mb-2">Password</label> <input type="password"
										id="pw" class="form-control" name="Doctor_password"
										placeholder="enter the password" required="required">
								</div>
								<button type="submit" class="btn submit mb-4" value="Go"
									class="circle" onclick="startchating();">Login</button>
								<p class="forgot-w3ls text-center pb-4">
									<a href="#" data-toggle="modal" data-target="#forget"
										class="text-white">Forgot your password?</a>
								</p>
								<p class="account-w3ls text-center pb-4">
									Don't have an account? <a href="#" data-toggle="modal"
										data-target="#exampleModalCenter2">Create one now</a>
								</p>
							</form>
						</div>
					</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="login px-4 mx-auto mw-100">
							...
							<h5 class="text-center mb-4">&nbsp;&nbsp;&nbsp;&nbsp; Forget
								password</h5>

							<form action="ForgetPasswordDoctor" method="post">
								<div class="form-group">
								...
								<div class="form-group">
									<label class="mb-2"> New Password</label> <input
										type="password" class="form-control"
										name="Doctor_passwordnew" placeholder="enter the password"
										required="required">
								</div>
								<div class="form-group">
									<label class="mb-2"> Confirm Password</label> <input
										type="password" class="form-control"
										name="Doctor_passwordconfirm"
										placeholder="enter the password" required="required">
								</div>
								<button type="submit" class="btn submit mb-4" value="Go"
									class="circle"">Reset Password</button>
								<p class="forgot-w3ls text-center pb-4"></p>
							</form>
						</div>
					</div>
				</div>
				...
				<div class="modal-content modal-content-2">
					...
					<div class="modal-body">
						<div class="login px-4 mx-auto mw-100">
							...
							<form action="Doctor_Registration" method="post">
								<div class="form-group">
									<br> <br> <br> <br> <br>
									<br> <br>
									<br> <label>Doctor Full Name</label> <input type="text"
										class="form-control" name="Doctor_fullname"
										placeholder="Enter Your Name" required="required" value="Dr.">
								</div>

								<div class="form-group">
									<label>Doctor Email</label> <input type="email"
										class="form-control" name="Doctor_email"
										placeholder="Enter the valid Email" required="required">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label>Mobile Number</label> <input type="tel"
										class="form-control" name="Doctor_mobile"
								...
								<div class="form-row">
									<div class="form-group">
										<label> Doctor Specialization </label> <select
											...
											<option>ENT</option>
											<option>Gastroenteric Surgery</option>
									...
									<div class="form-group col-md-4">
										<label> Gender </label> <select class="form-control"
											id="exampleFormControlSelect1" name="Doctor_gender">
											<option>Male</option>
								...
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="inputCity">City</label> <input type="text"
											class="form-control" id="inputCity" name="Doctor_city">
									</div>

									<div class="form-group col-md-4">
										<label for="inputState">State</label> <select id="inputState"
											class="form-control" name="Doctor_state">
									...
									<p class="text-center pb-2">
										<a href="#" class="text-white">By clicking Register, I
				...
				<li>
					<div class="banner-top1">
						<div class="banner-info_agile_w3ls">
							<div class="container">
								<h3>
									Medical services that you <span>can trust</span>
								</h3>
								<p class="mt-3 mb-md-5 mb-3">HELLO DOCTOR THE TRUST AGENT</p>
								<a href="about.html">Read More <i
									class="fa fa-caret-right ml-2" aria-hidden="true"></i>
								</a>
							</div>
						</div>
					</div>
				...
				<li>
					<div class="banner-top2">
						<div class="banner-info_agile_w3ls">
							<div class="container">
								<h3>
									Medical excellence <span>every day</span>
								</h3>
								<p class="mt-3 mb-md-5 mb-3">sHELLO DOCTOR THE TRUST AGENT</p>
								<a href="about.html">Read More <i
									class="fa fa-caret-right ml-2" aria-hidden="true"></i>
								</a>
							</div>
				...
				<li>
					<div class="banner-top3">
						<div class="banner-info_agile_w3ls">
							<div class="container">
								<h3>
									The Hospital of the <span>future, today</span>
								</h3>
								<p class="mt-3 mb-md-5 mb-3">sed do eiusmod tempor
	...
	<div class="banner-bottom py-5">
		<div class="d-flex container py-xl-3 py-lg-3">
			<div class="banner-left-bottom-w3ls offset-lg-2 offset-md-1">
				...
				<p>all specialists have extensive practical experience and
					regularly training courses in educational centers of the world</p>
			</div>
			<div class="button">
				<a href="about.html" class="w3ls-button-agile">Read More <i
	...
	<div class="why-choose-agile pt-5" id="services">
		<div class="container pt-xl-5 pt-lg-3">
			<div class="w3ls-titles text-center mb-5">
				...
				<p class="mt-2">HELLO DOCTOR THE TRUST AGENT</p>
			</div>
				...
				<div class="col-lg-4 agileits-w3layouts-grid">
					<div class="row wthree_agile_us">
						...
						<div class="col-9 agile-why-text-2">
							<h4 class="text-dark font-weight-bold mb-3">General health
								care</h4>
					...
					<div class="row wthree_agile_us">
						...
						<div class="col-9 agile-why-text-2">
							<h4 class="text-dark font-weight-bold mb-3">Medical
								Treatment</h4>
							<p>Lorem ipsum magna, vehicula ut porta ete.</p>
						</div>
					</div>
	...
	<div class="blog-w3ls py-5" id="blog">
		<div class="container py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				...
				<span> <i class="fas fa-user-md text-white"></i>
				</span>
				<p class="mt-2 text-white">Sed do eiusmod tempor incididunt ut
					labore et dolore magna aliqua.</p>
			</div>
			<div class="row package-grids mt-5">
				<div class="col-md-4 pricing">
					<div class="price-top">
						<a href="single.html"> <img src="images/blog1.jpg" alt=""
							class="img-fluid" />
						</a>
						<h3>
							13 <span>August</span>
					...
					<div class="price-bottom p-4">
						<h4 class="text-dark mb-3">Sit voluptatem accusantium
							doloremque</h4>
						<a href="single.html"> <i class="fas fa-user mr-2"></i>Posted
							by accusantium
						</a>
					</div>
				</div>
				<div class="col-md-4 pricing my-md-0 my-5">
					<div class="price-top">
						<a href="single.html"> <img src="images/blog2.jpg" alt=""
							class="img-fluid" />
						</a>
						<h3>
							24 <span>August</span>
				...
				<div class="col-md-4 pricing">
					<div class="price-top">
						<a href="single.html"> <img src="images/blog3.jpg" alt=""
							class="img-fluid" />
						</a>
						<h3>
							30 <span>August</span>
					...
					<div class="price-bottom p-4">
						<h4 class="text-dark mb-3">HELLO DOCTOR</h4>
						<a href="single.html"> <i class="fas fa-user mr-2"></i>HEllO
							DOCTOR
						</a>
					</div>
				</div>
			...
			<div class="container py-xl-5 py-lg-3">
				<div class="row">
					<div class="col-md-4 w3l-footer">
						<h2 class="mb-sm-3 mb-2">
							<a href="index.html"
								class="text-white font-italic font-weight-bold">HELLO DOCTOR
							</a>
						</h2>
						<p>HELLO DOCTOR</p>
					</div>
					<div class="col-md-4 w3l-footer my-md-0 my-4">
						...
						<ul class="list-unstyled">
							<li><i class="fas fa-location-arrow float-left"></i>
								<p class="ml-4">
									Hello Doctor <span>Hello DoctorDoctor,</span>New York,Morris
									Park.
								</p>
							...
							<li><i class="far fa-envelope-open float-left"></i> <a
								href="mailto:info@example.com" class="ml-3">mail@example.com</a>
								<div class="clearfix"></div></li>
						</ul>
					</div>
					<div class="col-md-4 w3l-footer">
						...
						<div class="nav-w3-l">
							<ul class="list-unstyled">
								<li><a href="DoctorIndex.jsp">Home</a></li>
								<li class="mt-2"><a href="about.html">About Us</a></li>
								<li class="mt-2"><a href="gallery.html">Gallery</a></li>
				...
				<div class="border-top mt-5 pt-lg-4 pt-3 pb-lg-0 pb-3 text-center">
					<p class="copy-right-grids mt-lg-1">
						© 2021 Hello Doctor. All Rights Reserved <a href=""
							target="_blank">Aps</a>
					</p>
				</div>
			</div>
