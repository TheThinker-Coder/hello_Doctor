...
@WebServlet(name = "DoctorDownloadServlet", urlPatterns = {"/DoctorDownloadServlet"})
public class DoctorDownloadServlet extends HttpServlet {

    public static int BUFFER_SIZE = 1024 * 100;
    public static final String UPLOAD_DIR = "dfiles";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         */
        fileName = request.getParameter("doctorfilename");
